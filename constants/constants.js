...
export const TASKS = [
  {
    ...
    successSubtitle: "Your energy-saving action today is lighting the way to a greener future!",
  ...
  },
  {
    ...
    points: 3,
    saved: 1.2,
    info: "Many electronics consume power even when turned off, known as 'phantom load.' Unplugging or switching off devices prevents this waste, reducing energy consumption and lowering carbon emissions generated by electricity production.",  successTitle: "Power down!",
    successSubtitle: "Your action to unplug electronics is a step toward a more sustainable future!",
  ...
  },
  {
    ...
    successSubtitle: "Your action to unplug chargers is a small step with a big impact on energy conservation!",
  },
  {
    id: 4,
    ...
    successSubtitle: "Your choice to take shorter showers is a refreshing step toward water conservation and sustainability!",
  },
  {
    id: 5,
    ...
    successSubtitle: "Your choice to use a reusable bottle is a refreshing step toward a cleaner planet!",
  },
  {
    id: 6,
    ...
    successSubtitle: "Your choice to use alternative transportation is a step toward cleaner air and a healthier planet!",
  },
  {
    id: 7,
    ...
    successSubtitle: "Your choice to enjoy a plant-based meal is a delicious step toward a more sustainable diet!",
  },
  {
    id: 8,
    ...
    successSubtitle: "Your choice to avoid single-use plastics is a step toward a cleaner environment and a healthier future!",
  },
  {
    id: 9,
    ...
    successSubtitle: "Your commitment to proper recycling is a valuable contribution to a more sustainable future!"
  },
  {
    id: 10,
    ...
    successSubtitle: "Your choice to air-dry clothes is a step toward a more sustainable lifestyle and a greener planet!",
  },
  {
    id: 11,
    ...
    successSubtitle: "Your choice to use a reusable coffee cup is a small action with a big impact on waste reduction and sustainability!",
  },
  {
    id: 12,
    ...
    successSubtitle: "Your choice to compost food scraps is a valuable contribution to a healthier planet and a more sustainable future!",
  },
  {
    id: 13,
    ...
    successSubtitle: "Your action to fix leaky taps is a drop in the bucket toward water conservation and a greener future!",
  },
  {
    id: 14,
    ...
    successSubtitle: "Your choice to buy local and seasonal produce is a step toward a more sustainable diet and a healthier planet!",
  },
  {
    id: 15,
    ...
    successSubtitle: "Your choice to use eco-friendly cleaning products is a step toward a healthier home and a cleaner environment!",
  }
];
